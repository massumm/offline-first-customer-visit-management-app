...
class TraineeOnboardingTimePreferTrainScreen extends GetView<TraineeOnboardingController>  {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            20.height,
            ...controller.timePreferTrain.map((option) => Container(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  Get.to(() => TraineeOnboardingReminderSelectedTimeScreen());
                },
                child: Row(
