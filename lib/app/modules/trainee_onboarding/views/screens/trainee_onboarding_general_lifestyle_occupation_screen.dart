...
import 'trainee_onboarding_achieve_each_day_screen.dart';

class TraineeOnboardingGeneralLifestyleOccupationScreen extends GetView<TraineeOnboardingController>  {
  const TraineeOnboardingGeneralLifestyleOccupationScreen({super.key});
          ...
          children: [
            ...
            ...controller.occupationTraining.map((option) => Container(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  Get.to(() => TraineeOnboardingAchieveEachDayScreen());
                },
                child: Row(
